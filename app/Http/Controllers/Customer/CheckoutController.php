        ...
        if (!is_null($cart) && count($cart) > 0) {
            ...
            foreach ($cart as $key => $item) {
                ...
                if ($stock < $item['qty']) {
                    ...
                    if(isset($total_cart[$variant->id]['qty'])) $total_cart[$variant->id]['qty'] = $stock;
            ...
            return redirect()->route('frontend.home')->withErrors('Please add some product into the cart!');
        }
    }
}
