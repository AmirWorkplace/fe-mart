...
@section('content')
    @include('layouts.frontend.partial.breadcrumb', [
        ...
        'category_link' => Route('frontend.products', $categories[0]['slug']),
                ...
                <div class="col-md-6">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <div class="product-availability">
                            ...
                            <span id="product-availability" class="product-available">
                                ...
                                <span
                                    class="out-of-stock text-danger {{ $current_stock > 0 ? 'd-none' : 'd-inline-block' }}">
                                    Stock Out
                                </span>
                            </span>
                        </div>
                    ...
                    <div class="end">
                        ...
                        <div class="pro-cate">
                            ...
                            <span><a href="{{ Route('frontend.products', $categories[0]['slug']) }}"
                                    title="Computer">{{ $categories[0]['name'] }}</a></span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="custom-tab pt-4 pt-md-5" id="tab_section">
