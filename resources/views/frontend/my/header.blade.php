<header class="header">
  <div class="d-lg-block d-none p-0 fixed-header">
      ...
      <div class="fx">
          @auth 
            <div class="footer-area text-end px-2"><a href="#" class="text-light">{{ Auth::user()->name }}</a></div>
          @endauth
              ...
              <div class="col-lg-9 col-md-8 col-sm-3">
                  <nav class="desktop-menu">
                      <ul class="desktop-menu__list">
                          ...
                          <li class="desktop-menu__item"><a href="{{ route('frontend.products') }}" title="Product">
                            <i class="zmdi zmdi-assignment"></i>Product</a>
                          </li>
