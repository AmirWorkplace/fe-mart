                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                {{-- <img src="" id="image_old" class="mt-2" height="60" alt="Image"
                                    ...
                                    <input type="hidden" name="is_remove_image">

                                    <div class="position-relative" id="remove-other-img--{{ 1 }}">
                                        <img class="thumb" id="image_old" src="" alt="thumb-more-img">

                                        <span class="remove-other-img" remove-other-img-id="#remove-other-img--{{ 1 }}" remove-other-img="">x</span>
                                    </div>
                            </div>
                            <div class="col-12">
                                <div class="d-flex gap-3 align-items-center flex-wrap">
...
@push('js')
    <script type="text/javascript">
        $(document).ready(function() {
                    ...
                    success: (response) => {
                        if (response.status == 'success') {
                            ...
                            if (response.data.image) {
                                const src = `${window.location.origin}/${response.data.image}`;
                                $('#image_old').attr('src', src);
                                
                                $(".remove-other-img").attr("remove-other-img", response.data.image);
                                $('#remove-other-img--1').show();
                            } else {
                                $('#remove-other-img--1').hide();
                            }
            ...
            $(".remove-other-img").click(function(){
                const removeId = $(".remove-other-img").attr("remove-other-img-id");

                $('[name="is_remove_image"]').val($(".remove-other-img").attr("remove-other-img"));
                $(removeId).remove();
            })
        });
    </script>
