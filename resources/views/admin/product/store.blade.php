            ...
            <form action="{{ Route('admin.product.store') }}" method="POST" enctype="multipart/form-data" id="choice_form">
                    ...
                    <div class="card-header">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div class="flex-shrink-0">
                                ...
                                <button id="product-save-btn" class="btn btn-sm btn-success">Upload Product</button>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="number" class="form-control" id="vendor_price" name="vendor_price"
                                            required placeholder="Vendor Price" value="0">
                                    </div>
                                    <div class="col-sm-6">
                                        ...
                                        <input type="number" class="form-control" id="reseller_price" name="reseller_price"
                                            required placeholder="Reseller Price" value="0">
                                    </div>
                                    <div class="col-sm-6">
                            ...
                            <div class="col-lg-6">
                                <div class="row g-3">
                                    <div class="col-sm-6">
                                        ...
                                        <input name="code" id="product-code" class="form-control custom-input" placeholder="#******" required />
                                    </div>
                                    <div class="col-sm-6">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <select name="main_category_id[]" id="parent_category" class="select form-select"
                                            required data-placeholder="Select Category.." multiple>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <select name="child_category_id[]" id="child_category" class="select form-select"
                                            data-placeholder="Choose.." multiple></select>
                                    </div>
                                    <div class="col-sm-6">
                ...
                <div class="card mt-3">
                    ...
                    <div class="card-footer text-end">
                        <button type="submit" class="btn btn-sm btn-success">Upload Product</button>
                    </div>
                </div>
            </form>
        </div>
...
@push('js')
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#product-code").on('change keyup click', function(){
                console.log($("#product-code").val())
                $.ajax({
                    url: "{{ route('admin.validate-product-code') }}",
                    method: 'POST',
                    data: { code: $("#product-code").val() },
