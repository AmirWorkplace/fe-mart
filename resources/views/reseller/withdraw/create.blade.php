            ...
            <div class="card">
                ...
                <div class="card-body p-4">
                    <div class="row g-3">
                        ...
                        <div class="show-account col-md-6" id="show_payment_method"></div>
                        <div class="col-md-6">
                            <label for="phone" class="form-label require"><b>Withdraw Amount</b></label>
                            <input type="withdraw_amount" placeholder="0.00" class="form-control custom-input" id="withdraw_amount" name="withdraw_amount" required>
                        </div>
                        <div class="col-md-6">
