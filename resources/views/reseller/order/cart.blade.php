                                                              ...
                                                              product-quantities qty-input="#quantity_wanted_{{ $key }}">
                                                                ...
                                                                <span class="input-group-btn-vertical">
                                                                    <button class="btn btn-touchspin qty-plus" type="button"
                                                                      qty-input=".product_qty__{{ $key }}" price="{{ $item['price'] }}"
                                                                       data-id="{{ $item['variant_id'] }}" total-price-id=".product_price__{{ $key }}">
                                                                        <i class="fal fa-plus"></i></button>

                                                                    <button class="btn btn-touchspin qty-minus bootstrap-touchspin-down"
                                                                     data-id="{{ $item['variant_id'] }}" price="{{ $item['price'] }}"
                                            ...
                                            <div class="col-md-2 d-flex align-items-center">
                                                <div class="price">
                                                    <div class="product-price total">
                                                        {{-- ৳ {{ $item['price'] * $item['qty'] }} --}}
                                                        <span>৳</span> 
                                                        <span class="total_prices product_price__{{ $key }}">{{ $item['price'] * $item['qty'] }}</span>
                                                    </div>
                                                </div>
                        ...
                        <div class="cart-detailed-totals">
                            ...
                            <div class="group-price">
                                <div class="cart-summary-line" id="cart-subtotal-products">
                                    ...
                                    <span class="value">৳ 
                                        <span class="total_cart_price" id="total_cart_price">{{ number_format($cart_total_price, 2) }}</span>
                                    </span>
                                </div>
