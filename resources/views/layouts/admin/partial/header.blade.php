<div class="navbar-header shadow-sm text-light" style="background: #105caa;">
    <div class="px-sm-3 px-10px d-flex gap-2 align-items-center justify-content-between">
        ...
        <div class="d-flex align-items-center">
            <div class="dropdown ms-sm-3 header-item topbar-user">
                <button type="button" class="btn btn-light rounded-0 border-0" style="background: #105caa;" data-bs-toggle="dropdown">
                    <span class="d-flex align-items-center">
                        ...
                        <span class="ms-2 text-start d-md-block d-none">
                            <span class="fs-15 d-block lh-1 ms-1 text-light">{{ Auth::user()->name }}</span>
